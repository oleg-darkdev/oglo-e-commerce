<section class="bg-primary">
	<div class="container mx-auto px-6 py-10">
		<div class="lg:flex lg:items-center">
			<div class="w-full space-y-12 lg:w-1/2 ">
				...
				<div>
					...
					<div class="mt-2">
						<span class="inline-block h-1 w-40 rounded-full bg-secondary" />
						<span class="ml-1 inline-block h-1 w-3 rounded-full bg-secondary" />
						<span class="ml-1 inline-block h-1 w-1 rounded-full bg-secondary" />
					</div>
				</div>
		...
		<!-- <div class="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1">
				<svg
					class="h-12 fill-current text-gray-500 dark:text-gray-300"
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 266 100"
			...
			<div class="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1">
				<svg
					class="h-10 fill-current text-gray-500 dark:text-gray-300"
					xmlns="http://www.w3.org/2000/svg"
			...
			<div class="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1">
				<svg
					class="mt-2 h-8 fill-current text-gray-500 dark:text-gray-300"
					viewBox="0 0 398 120"
					xmlns="http://www.w3.org/2000/svg"
					><g fill-rule="nonzero"
						><path
			...
			<div class="col-span-1 flex items-center justify-center md:col-span-3 lg:col-span-1">
				<svg
					class="mt-1 h-5 fill-current text-gray-500 dark:text-gray-300"
					xmlns="http://www.w3.org/2000/svg"
			...
			<div class="col-span-2 flex items-center justify-center md:col-span-3 lg:col-span-1">
				<svg
					class="h-8 fill-current text-gray-500 dark:text-gray-300"
