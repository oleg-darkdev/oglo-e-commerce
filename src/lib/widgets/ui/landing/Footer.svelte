	...
	<div class="container mx-auto px-6 py-8">
		<div class="flex flex-col items-center text-center">
			...
			<div class="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-center">
				<a
					target="_blank"
					href="https://www.youtube.com/watch?v=Z6uoN7TR0Z0?autoplay=1"
					class="order-1 mt-3 flex w-full transform items-center justify-center rounded-md border px-2 py-2 text-sm capitalize tracking-wide text-gray-600 transition-colors duration-300 hover:bg-gray-50 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-40 dark:border-gray-400 dark:text-gray-300  sm:mx-2 sm:mt-0 sm:w-auto"
				>
					<svg
						class="mx-1 h-5 w-5"
						viewBox="0 0 24 24"
